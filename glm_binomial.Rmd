...
- Sample size information is lost!
...
## Contrasts in survival among classes
...
Example dataset: `survival_expt.csv`

\vspace{3mm}

```{r surv_read, echo = TRUE}
surv <- readr::read_csv('data/survival_expt.csv')
head(surv)
```


## Q: Is survival related to environmental stress?
...
```{r surv_visreg, echo=TRUE}
visreg(surv.glm, scale = 'response')
```


## Check model (easystats)
...
## Testing for overdispersion (easystats)
