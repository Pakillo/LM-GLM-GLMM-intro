...
$\overline {x} \pm 2*SD$ enclose 95% of the data

$\overline {x} \pm 3*SD$ enclose 99% of the data
...
plot(setosa$Petal.Length, fitted(m1),     
     xlab = "Petal length - observed", ylab = "Petal length - predicted", las = 1, xlim = c(1,2), ylim = c(1,2))
abline(a = 0, b = 1)
```
