...
## Colliders induce negative relation between treatment (flower.size) and outcome (seeds)
...
Include **CONFOUNDERS** to avoid bias (backdoor criterion)
...
y = x1 + x2 + rnorm(100)
kable(head(data.frame(y, x1, x2)), digits = 1)
```
