...
data.frame(h = rnorm(1000, 1.7, 0.4)) |> 
  ggplot() +
  geom_density(aes(h)) +
  theme_minimal(base_size = 32) +
  labs(x = "Height (m)")
...
Intercept: Expected height of 25-cm DBH tree

`b` (slope): How much tree height varies (in m) when DBH increases 1 cm

`sigma`: residual standard deviation (model error)
...
[Statistical rethinking with brms, ggplot2, and the tidyverse](https://solomon.quarto.pub/sr/)
