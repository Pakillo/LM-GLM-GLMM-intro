...
modelsummary(m1, output = "markdown")  # docx, LaTeX, png...
```
...
## Plot model: `see` package (easystats)
...
```{r }
modelsummary(m3, estimate  = "{estimate} ({std.error})", statistic = NULL, output = "markdown")
```
