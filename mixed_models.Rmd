...
```{r mixed_vis3, echo=2}
library(visreg)
visreg(mixed, xvar = "dbh", by = "plot", re.form = ~(1|plot))
```
...
```{r echo=FALSE}
include_graphics("images/mixed.PNG")
```
...
```{r mixed_plot, eval=FALSE, echo=FALSE}
...
## Predicting heights at NEW plots!
#https://github.com/lme4/lme4/issues/388#issuecomment-231398937
newtree <- data.frame(dbh = 30, plot = as.factor(25))
p <- bootMer(mixed, 
