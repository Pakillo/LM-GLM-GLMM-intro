...
- Download [this dataset](https://raw.githubusercontent.com/Pakillo/LM-GLM-GLMM-intro/trees/data/trees.csv) (or the entire [zip file](https://github.com/Pakillo/LM-GLM-GLMM-intro/archive/refs/heads/trees.zip))
...
\Large Does tree height vary with sex?
...
\normalsize p-value = 0.133 corresponds to *surprise* of obtaining c. 3 heads in a row when tossing a coin

\scriptsize https://marginaleffects.com/bonus/svalues.html
