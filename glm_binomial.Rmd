...
4. **Back-transform parameters** from *logit* into probability scale (e.g. `allEffects`, `estimate_means`)
...
# visreg(tit.sex.class.int, by = "sex", xvar = "class")
```
:::
::::::::::::::
